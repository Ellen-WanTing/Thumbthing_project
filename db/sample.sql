...
GRANT PROCESS, SELECT, EXECUTE, SHOW VIEW ON *.* to 'admin' ;
flush privileges;
...
CREATE TABLE `Action` (
  ...
  KEY `fk_action_book_idx` (`BookID`),
  KEY `fk_action_user_idx` (`UserID`),
  KEY `fk_action_summary_idx` (`SummaryID`),
  KEY `fk_action_comment_idx` (`CommentID`),
  CONSTRAINT `fk_action_book` FOREIGN KEY (`BookID`) REFERENCES `Book` (`BookID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_action_comment` FOREIGN KEY (`CommentID`) REFERENCES `Comment` (`CommentID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_action_summary` FOREIGN KEY (`SummaryID`) REFERENCES `Summary` (`SummaryID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_action_user` FOREIGN KEY (`UserID`) REFERENCES `User` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `Book` (
  ...
  `YearOfPublication` varchar(100) DEFAULT NULL,
  ...
  KEY `fk_Book_Publisher_idx` (`PublisherID`),
  FULLTEXT KEY `ft_book_title_idx` (`Title`),
  CONSTRAINT `fk_Book_Author` FOREIGN KEY (`AuthorID`) REFERENCES `Author` (`AuthorID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_Book_Cat` FOREIGN KEY (`CategoryID`) REFERENCES `Category` (`CategoryID`),
  CONSTRAINT `fk_Book_Publisher` FOREIGN KEY (`PublisherID`) REFERENCES `Publisher` (`PublisherID`)
) ENGINE=InnoDB AUTO_INCREMENT=69966 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Bookmark` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`BookmarkID`),
  KEY `UserID_idx` (`UserID`),
  KEY `BookID_idx` (`BookID`),
  CONSTRAINT `fk_Bookmark_Book` FOREIGN KEY (`BookID`) REFERENCES `Book` (`BookID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_Bookmark_User` FOREIGN KEY (`UserID`) REFERENCES `User` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `Category` (
  ...
  `ParentCatID` int NOT NULL DEFAULT '-1',
  `ViewNumber` int DEFAULT '0',
...
CREATE TABLE `Comment` (
  ...
  KEY `UserID_idx` (`UserID`),
  KEY `SummeryID_idx` (`SummaryID`),
  CONSTRAINT `fk_Comment_Summary` FOREIGN KEY (`SummaryID`) REFERENCES `Summary` (`SummaryID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `Summary` (
  ...
  `SummaryText` varchar(15000) NOT NULL,
  PRIMARY KEY (`SummaryID`),
  UNIQUE KEY `ID_UNIQUE` (`SummaryID`),
  KEY `fk_Summary_Book_idx` (`BookID`),
  KEY `fk_Summary_Cat_idx` (`UserID`),
  FULLTEXT KEY `ft_summary_text_idx` (`SummaryText`),
  CONSTRAINT `fk_Summary_Book` FOREIGN KEY (`BookID`) REFERENCES `Book` (`BookID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_Summary_User` FOREIGN KEY (`UserID`) REFERENCES `User` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `actionAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `actionAdd`(uID int, bID int,
sID int, cID int, aLabel varchar(100))
    SQL SECURITY INVOKER
BEGIN
if strcmp(aLabel, 'like') = 0 or strcmp(aLabel, 'report') = 0 or
strcmp(aLabel, 'bookmark') = 0 or strcmp(aLabel, 'rating') = 0 then
INSERT INTO Action (`UserID`,`BookID`,`SummaryID`,`CommentID`,`ActionLabel`)
values (uID, bID, sID, cID, aLabel);
end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `actionCheck` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `actionCheck`(userID int, subjectID int,
subjectLabel varchar(100), actionLabel varchar(100))
    SQL SECURITY INVOKER
BEGIN
if strcmp(subjectLabel, 'Book') = 0  and
(strcmp(actionLabel, 'bookmark') = 0 or strcmp(actionLabel, 'rating') = 0) then
select * from Action where Action.UserID = userID
and Action.BookID = subjectID and Action.ActionLabel = actionLabel;

elseif strcmp(subjectLabel, 'Summary') = 0 and (strcmp(actionLabel, 'like') = 0 or
strcmp(actionLabel, 'report') = 0 or strcmp(actionLabel, 'bookmark') = 0) then
select * from Action where Action.UserID = userID
and Action.SummaryID = subjectID and Action.ActionLabel = actionLabel;

elseif strcmp(subjectLabel, 'Comment') = 0 and strcmp(actionLabel, 'report') = 0 then
select * from Action where Action.UserID = userID
and Action.CommentID = subjectID and Action.ActionLabel = actionLabel;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `actionDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `actionDelete`(userID int, subjectID int,
subjectLabel varchar(100), actionLabel varchar(100))
    SQL SECURITY INVOKER
BEGIN
if strcmp(subjectLabel, 'Book') = 0  and
(strcmp(actionLabel, 'bookmark') = 0 or strcmp(actionLabel, 'rating') = 0) then
DELETE FROM `sys`.`Action` where UserID = userID
and BookID = subjectID and Action.ActionLabel = actionLabel;

elseif strcmp(subjectLabel, 'Summary') = 0 and (strcmp(actionLabel, 'like') = 0 or
strcmp(actionLabel, 'report') = 0 or strcmp(actionLabel, 'bookmark') = 0) then
DELETE FROM `sys`.`Action` where UserID = userID
and SummaryID = subjectID and Action.ActionLabel = actionLabel;

elseif strcmp(subjectLabel, 'Comment') = 0 and strcmp(actionLabel, 'report') = 0 then
DELETE FROM `sys`.`Action` where UserID = userID
and CommentID = subjectID and Action.ActionLabel = actionLabel;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `addViewNumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `addViewNumber`(aID int, bID int, cID int, pID int)
    SQL SECURITY INVOKER
BEGIN
CALL `sys`.`authorViewNumber`(aID);
CALL `sys`.`bookViewNumber`(bID);
CALL `sys`.`categoryViewNumber`(cID);
CALL `sys`.`publisherViewNumber`(pID);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorAdd`(authorName varchar(150))
    SQL SECURITY INVOKER
BEGIN
INSERT INTO Author (FullName)
SELECT * FROM (SELECT authorName AS FullName) AS tmp
WHERE NOT EXISTS (
    SELECT * FROM Author WHERE Author.FullName = authorName
) LIMIT 1;
SELECT * FROM `sys`.`Author` ORDER BY AuthorID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorDelete`(ID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Author` WHERE AuthorID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorRead`(pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Author ORDER BY ViewNumber LIMIT pageLimit OFFSET pageOffest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorReadAll` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorReadAll`()
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Author  order by ViewNumber desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorReadAllWithBooks` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorReadAllWithBooks`()
    SQL SECURITY INVOKER
BEGIN
SELECT a.*, b.TotalRating, b.TotalBooks, b2.* FROM Author as a
	inner join (
		select AuthorID, max(BookID) BookID, avg(Rating) TotalRating,
        count(BookID) TotalBooks from Book group by AuthorID) as b
	on a.AuthorID = b.AuthorID
    inner join Book b2
    on a.AuthorID = b2.AuthorID and b.BookID = b2.BookID  order by a.ViewNumber desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorReadSpecific` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorReadSpecific`(ID int)
    SQL SECURITY INVOKER
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorUpdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorUpdate`(ID int, authorName varchar(150))
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Author`
SET
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `authorViewNumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `authorViewNumber`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE vNum INT DEFAULT 0;
SELECT
    `Author`.`ViewNumber`
FROM `sys`.`Author` where `AuthorID` = ID into vNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookAddWithID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookAddWithID`(catID int,
writerID int, publisherID int, title varchar(150), yearOfPublication varchar(150),
rating double, lan varchar(150), image varchar(300))
    SQL SECURITY INVOKER
BEGIN
INSERT INTO Book (CategoryID, AuthorID, PublisherID, Title, YearOfPublication,
Rating, Language, Image)
SELECT * FROM (SELECT catId AS CategoryID, writerID AS AuthorID,
publisherID AS PublisherID, title AS Title, yearOfPublication AS YearOfPublication,
rating AS Rating, lan AS Language, image AS Image) AS tmp
WHERE NOT EXISTS (
    SELECT * FROM Book WHERE Book.CategoryID = catId AND Book.AuthorID = writerId AND Book.Title = title
) LIMIT 1;
SELECT * FROM `sys`.`Book` ORDER BY BookID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookAddWithName` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookAddWithName`(catName varchar(150),
fullName varchar(150), title varchar(150), yearOfPublication varchar(150),
rating double, lan varchar(150), image varchar(300), publisherName varchar(150))
    SQL SECURITY INVOKER
BEGIN
DECLARE catId INT DEFAULT -1;
DECLARE writerId INT DEFAULT -1;
DECLARE pubId INT DEFAULT -1;
CALL `sys`.`categoryAdd`(catName, -1);
SELECT CategoryID FROM Category WHERE Category.Name = catName INTO catId;
CALL `sys`.`authorAdd`(fullName);
SELECT AuthorID FROM Author WHERE Author.FullName = fullName INTO writerId;
CALL `sys`.`publisherAdd`(publisherName);
SELECT PublisherID FROM Publisher WHERE Publisher.FullName = publisherName INTO pubId;
select catId, writerId, pubID;
CALL `sys`.`bookAddWithID`(catId, writerId, pubId, title, yearOfPublication,
	rating, lan, image);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookDelete`(ID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Book` WHERE BookID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookmarkAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookmarkAdd`(userID int, bookID int)
    SQL SECURITY INVOKER
BEGIN
INSERT INTO `sys`.`Bookmark`
(`UserID`, `BookID`)
VALUES
(userID, bookID);
SELECT * FROM `sys`.`Bookmark` ORDER BY BookmarkID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookmarkDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookmarkDelete`(userID int, bookID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Bookmark` WHERE UserID = userID and BookID = bookID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookmarkRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookmarkRead`(ID int)
    SQL SECURITY INVOKER
BEGIN
SELECT b.* FROM Bookmark m natural JOIN Book b WHERE UserID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookRating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookRating`(ID int, rating double)
    SQL SECURITY INVOKER
BEGIN
DECLARE ratingNum double DEFAULT 0;
SELECT
    `Book`.`Rating`
FROM `sys`.`Book` where `BookID` = ID into ratingNum;

set ratingNum = (ratingNum + rating)/2;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookRead`(pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
SELECT b.*, a.FullName AuthorName, c.Name CategoryName, p.FullName PublisherName
FROM sys.Book b
inner JOIN sys.Author a on b.AuthorID = a.AuthorID
inner JOIN sys.Category c on b.CategoryID = c.CategoryID
inner JOIN sys.Publisher p on b.PublisherID = p.PublisherID
ORDER BY b.ViewNumber LIMIT pageLimit OFFSET pageOffest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookReadAll` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookReadAll`()
    SQL SECURITY INVOKER
BEGIN
SELECT b.*, a.FullName AuthorName, c.Name CategoryName, p.FullName PublisherName
FROM sys.Book b
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookReadByFilter` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookReadByFilter`(catID varchar(50),
	authorID varchar(50), bookID varchar(50), publisherID varchar(300),
    pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
DECLARE whereClause varchar(200) DEFAULT ' WHERE';
DECLARE rangeClause varchar(200) DEFAULT '';
DECLARE isWhereAdded boolean default false;

IF isnull(catID) = 0 THEN
SET whereClause = CONCAT(whereClause, ' b.CategoryID = ', catID);
SET isWhereAdded = true;
END IF;

IF isnull(authorID) = 0 then
if isWhereAdded = true then set whereClause = CONCAT(whereClause, ' AND');
end if;
set whereClause = CONCAT(whereClause, ' b.AuthorID = ', authorID);
set isWhereAdded = true;
END IF;

IF isnull(bookID) = 0 then
if isWhereAdded = true then set whereClause = CONCAT(whereClause, ' AND');
end if;
set whereClause = CONCAT(whereClause, ' b.BookID = ', bookID);
set isWhereAdded = true;
END IF;

IF isnull(publisherID) = 0 then
if isWhereAdded = true then set whereClause = CONCAT(whereClause, ' AND');
end if;
set whereClause = CONCAT(whereClause, ' b.PublisherID = ', publisherID);
END IF;

if pageOffest != -1 And pageLimit != -1 then
set rangeClause = concat(rangeClause, ' LIMIT ', pageLimit, ' OFFSET ', pageOffest);
end if;

set @sqlClause = 'SELECT b.*, a.FullName AuthorName, c.Name CategoryName,
p.FullName PublisherName FROM sys.Book b
inner JOIN sys.Author a on b.AuthorID = a.AuthorID
inner JOIN sys.Category c on b.CategoryID = c.CategoryID
inner JOIN sys.Publisher p on b.PublisherID = p.PublisherID';

set @sqlClause = CONCAT(@sqlClause, whereClause, rangeClause);
PREPARE stmt1 FROM @sqlClause;
execute stmt1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookReadRandom` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookReadRandom`()
    SQL SECURITY INVOKER
BEGIN
SELECT b.*, a.FullName AuthorName, c.Name CategoryName, p.FullName PublisherName
	FROM sys.Book b
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookUpdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookUpdate`(ID int, catID int, writerID int,
title varchar(150), yearOfPublication varchar(150), rating double,
lan varchar(150), image varchar(300), publisherID int)
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Book`
SET
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bookViewNumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `bookViewNumber`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE vNum INT DEFAULT 0;
SELECT
    `Book`.`ViewNumber`
FROM `sys`.`Book` where `BookID` = ID into vNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryAdd`(catName varchar(150),
parentCatID int)
    SQL SECURITY INVOKER
BEGIN
INSERT INTO Category (Name, ParentCatID)
SELECT * FROM (SELECT catName AS Name, parentCatID AS ParentCatID) AS tmp
WHERE NOT EXISTS (
    SELECT * FROM Category WHERE Category.Name = catName
) LIMIT 1;
SELECT * FROM `sys`.`Category` ORDER BY CategoryID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryDelete`(catID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Category` WHERE CategoryID = catID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryRead`(pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Category ORDER BY ViewNumber LIMIT pageLimit OFFSET pageOffest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryReadAll` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryReadAll`()
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Category  order by ViewNumber desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryReadByID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryReadByID`(catID int)
    SQL SECURITY INVOKER
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryReadByParent` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryReadByParent`(catID int)
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Category WHERE ParentCatID = catID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryUpdate`(catID int, parentID int,
catName varchar(150))
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Category`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `categoryViewNumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `categoryViewNumber`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE vNum INT DEFAULT 0;
SELECT
    `Category`.`ViewNumber`
FROM `sys`.`Category` where `CategoryID` = ID into vNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `checkAction` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `checkAction`(userID int, subjectID int,
subjectLabel varchar(100), actionLabel varchar(100))
    SQL SECURITY INVOKER
BEGIN
if strcmp(subjectLabel, 'Book') = 0  and
(strcmp(actionLabel, 'bookmark') = 0 or strcmp(actionLabel, 'rating') = 0) then
select * from Action where UserID = userID
and BookID = subjectID and Action.ActionLabel = actionLabel;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentAdd`(userID int, summaryID int, commentText varchar(500))
    SQL SECURITY INVOKER
BEGIN
INSERT INTO `sys`.`Comment`
(`UserID`, `SummaryID`, `Text`)
VALUES
(userID, summaryID, commentText);
SELECT * FROM `sys`.`Comment` ORDER BY CommentID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentDelete`(ID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Comment`
WHERE CommentID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentRead`(sID int)
    SQL SECURITY INVOKER
BEGIN
SELECT c.*, u.FullName, u.Email FROM Comment c
natural JOIN User u WHERE c.Reported < 6 AND c.SummaryID = sID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentReadByID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentReadByID`(ID int)
    SQL SECURITY INVOKER
BEGIN
SELECT c.*, u.FullName, u.Email FROM Comment c
natural JOIN User u WHERE c.Reported < 6 AND c.CommentID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentReport` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentReport`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE reportNum INT DEFAULT 0;
SELECT
    `Comment`.`Reported`
FROM `sys`.`Comment` where `CommentID` = ID into reportNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `commentUpdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `commentUpdate`(ID int, commentText varchar(500))
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Comment`
SET
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `new_procedure`(userID int, subjectID int,
subjectLabel varchar(100), actionLabel varchar(100))
    SQL SECURITY INVOKER
BEGIN
if actionLabel = 'like' or actionLabel = 'report'
or actionLabel = 'bookmark' or actionLabel = 'rating' then
if subjectLabel = 'BookID' or subjectLabel = 'SummaryID'
or subjectLabel = 'CommentID' then
select * from Action where UserID = userID
and BookID = subjectID and ActionLabel = actionLabel;
end if;
end if;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherAdd`(publisherName varchar(150))
    SQL SECURITY INVOKER
BEGIN
INSERT INTO Publisher (FullName)
SELECT * FROM (SELECT publisherName AS FullName) AS tmp
WHERE NOT EXISTS (
    SELECT * FROM Publisher WHERE Publisher.FullName = publisherName
) LIMIT 1;
SELECT * FROM `sys`.`Publisher` ORDER BY PublisherID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherDelete`(ID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Publisher` WHERE PublisherID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherRead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherRead`(pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Publisher ORDER BY ViewNumber LIMIT pageLimit OFFSET pageOffest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherReadAll` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherReadAll`()
    SQL SECURITY INVOKER
BEGIN
SELECT * FROM Publisher  order by ViewNumber desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherReadAllWithBooks` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherReadAllWithBooks`()
    SQL SECURITY INVOKER
BEGIN
SELECT p.*, b.TotalRating, b.TotalBooks, b2.* FROM Publisher as p
	inner join (
		select PublisherID, max(BookID) BookID, avg(Rating) TotalRating,
        count(BookID) TotalBooks from Book group by PublisherID) as b
	on p.PublisherID = b.PublisherID
    inner join Book b2
    on p.PublisherID = b2.PublisherID and b.BookID = b2.BookID order by p.ViewNumber desc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherReadSpecific` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherReadSpecific`(ID int)
    SQL SECURITY INVOKER
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherUpdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherUpdate`(ID int, publisherName varchar(150))
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Publisher`
SET
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `publisherViewNumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `publisherViewNumber`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE vNum INT DEFAULT 0;
SELECT
    `Publisher`.`ViewNumber`
FROM `sys`.`Publisher` where `PublisherID` = ID into vNum;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `search`(keyword varchar(500),
	catActive int, authorActive int, publisherActive int, bookActive int,
    orderCatActive int, orderAuthorActive int, orderPublisherActive int,
    pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
declare searchKeyword varchar(550) DEFAULT '';
DECLARE whereClause varchar(200) DEFAULT ' WHERE';
DECLARE rangeClause varchar(200) DEFAULT '';
DECLARE orderClause varchar(200) DEFAULT ' ORDER BY';

DECLARE isOrderAdded boolean default false;
DECLARE isWhereAdded boolean default false;

set searchKeyword = concat("%", keyword, "%");

IF bookActive = 1 THEN
SET whereClause = CONCAT(whereClause, ' match(b.Title) against (\'', keyword, '\' IN BOOLEAN MODE)');
SET isWhereAdded = true;
END IF;

IF authorActive = 1 then
if isWhereAdded = true then set whereClause = CONCAT(whereClause, ' OR');
end if;
set whereClause = CONCAT(whereClause, ' a.Fullname like \'', searchKeyword, '\'');
set isWhereAdded = true;
END IF;
...
set whereClause = CONCAT(whereClause, ' c.Name like \'', searchKeyword, '\'');
set isWhereAdded = true;
END IF;

IF publisherActive = 1 then
if isWhereAdded = true then set whereClause = CONCAT(whereClause, ' OR');
end if;
set whereClause = CONCAT(whereClause, ' p.FullName like \'', searchKeyword, '\'');
END IF;
...
if orderCatActive = 1 then
set orderClause = concat(orderClause, ' c.CategoryID');
set isOrderAdded = true;
end if;

if orderAuthorActive = 1 then
if isOrderAdded = true then set orderClause = CONCAT(orderClause, ' ,');
end if;
set orderClause = concat(orderClause, ' a.AuthorID');
set isOrderAdded = true;
end if;

if orderPublisherActive = 1 then
if isOrderAdded = true then set orderClause = CONCAT(orderClause, ' ,');
end if;
set orderClause = concat(orderClause, ' p.PublisherID');
end if;

set @sqlClause = 'SELECT b.*, a.FullName AuthorName, c.Name CategoryName, p.FullName PublisherName FROM sys.Book b inner JOIN sys.Author a on b.AuthorID = a.AuthorID inner JOIN sys.Category c on b.CategoryID = c.CategoryID inner JOIN sys.Publisher p on b.PublisherID = p.PublisherID';

set @sqlClause = CONCAT(@sqlClause, whereClause, orderClause, rangeClause);
select @sqlClause;
PREPARE stmt1 FROM @sqlClause;
execute stmt1;
DEALLOCATE PREPARE stmt1;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `searchBook`(keyword varchar(500),
	catActive boolean, authorActive boolean, publisherActive boolean, bookActive boolean,
...
if orderCatActive then
set orderClause = concat(orderClause, ' c.CategoryID');
set isOrderAdded = true;
end if;

if orderAuthorActive then
if isOrderAdded = true then set orderClause = CONCAT(orderClause, ' ,');
end if;
set orderClause = concat(orderClause, ' a.AuthorID');
set isOrderAdded = true;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `searchSummary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `searchSummary`(keyword varchar(500),
    pageOffest int, pageLimit int)
    SQL SECURITY INVOKER
BEGIN
if pageOffest != -1 and pageLimit != -1 then
select * from Summary where match (SummaryText)
against (keyword IN NATURAL LANGUAGE MODE WITH QUERY EXPANSION)
limit pageLimit offset pageOffest;
else
select * from Summary where match (SummaryText)
against (keyword IN NATURAL LANGUAGE MODE WITH QUERY EXPANSION);
end if;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryAdd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryAdd`(userID int, bookID int, summary varchar(10000))
    SQL SECURITY INVOKER
BEGIN
INSERT INTO `sys`.`Summary`
(`UserID`, `BookID`, `SummaryText`)
VALUES
(userID, bookID, summary);
SELECT * FROM `sys`.`Summary` ORDER BY SummaryID DESC LIMIT 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryDelete`(ID int)
    SQL SECURITY INVOKER
BEGIN
DELETE FROM `sys`.`Summary`
WHERE SummaryID = ID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryLike` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryLike`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE likeNum INT DEFAULT 0;
SELECT
    `Summary`.`LikeNum`
FROM `sys`.`Summary` where `SummaryID` = ID into likeNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryReadByBook` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryReadByBook`(ID int)
    SQL SECURITY INVOKER
BEGIN
SELECT s.*, u.FullName UserName, u.Email UserEmail  FROM Summary s natural JOIN User u
	WHERE s.Reported < 6 AND s.BookID = ID order by s.LikeNum DESC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryReadByID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryReadByID`(ID int)
    SQL SECURITY INVOKER
BEGIN
SELECT s.*, u.FullName UserName, u.Email UserEmail FROM Summary s natural JOIN User u
	WHERE s.Reported < 6 AND s.SummaryID = ID order by s.LikeNum;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryReadByUser` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryReadByUser`(ID int)
    SQL SECURITY INVOKER
BEGIN
SELECT s.*, u.FullName UserName, u.Email UserEmail FROM Summary s natural JOIN User u
	WHERE s.Reported < 6 AND u.UserID = ID order by s.LikeNum;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryReport` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryReport`(ID int)
    SQL SECURITY INVOKER
BEGIN
DECLARE reportNum INT DEFAULT 0;
SELECT
    `Summary`.`Reported`
FROM `sys`.`Summary` where `SummaryID` = ID into reportNum;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summaryUpdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `summaryUpdate`(ID int, summary varchar(10000))
    SQL SECURITY INVOKER
BEGIN
UPDATE `sys`.`Summary`
SET
...
-- Dump completed on 2021-01-28 23:48:25
